  ...
  return (
    <Card
      ...
      style={{
        ...
        boxShadow: hovered ? `0 0 20px ${accentGlow}, 0 4px 12px hsl(0 0% 0% / 0.3)` : undefined,
      }}
    ...
    >
      <CardContent className="p-4 flex flex-col gap-2.5">
        ...
        <div className="flex items-center gap-2.5">
          <CoinIcon src={coin.png32} code={displayCode} color={coin.color} size={28} />
        ...
        {/* Sparkline */}
        <div className="-mx-1">
          <Sparkline coin={coin} height={48} />
        </div>

        {/* Deltas */}
        <div className="flex items-end justify-between border-t pt-2" style={{ borderColor: "hsl(228 14% 17%)" }}>
