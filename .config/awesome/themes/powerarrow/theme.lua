...
function theme.at_screen_connect(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            arrow("", "#777E76"),
            wibox.container.background(wibox.container.margin(wibox.widget { ram_widget(), layout = wibox.layout.align.horizontal }, dpi(2), dpi(3)), "#777E76"),
            -- kwibox.container.background(wibox.container.margin(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, dpi(2), dpi(3)), "#777E76"),
            arrow("#777E76", "#4B696D"),
            ...
            arrow("#343434", "#777E76"),
            wibox.container.background(wibox.container.margin(wibox.widget { nil, neticon, net.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), "#777E76"),
            -- arrow("#C0C0A2", "#777E76"),
            -- wibox.container.background(wibox.container.margin(binclock.widget, dpi(4), dpi(8)), "#777E76"), arrow("#777E76", "alpha"),
            --]]
            s.mylayoutbox,
        },
    }
