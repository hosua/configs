...
TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR=${TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR:-'#17274d'}
TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR=${TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR:-'#e1f0ff'}
...
if [ -z "$TMUX_POWERLINE_LEFT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_LEFT_STATUS_SEGMENTS=(
		"tmux_session_info #222222 #2282c0"
		"hostname #225fc0 255"
...
if [ -z "$TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
		...
		"date_day 235 #2282c0"
		"date 235 #2282c0 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
		"time 235 #2282c0 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
		"utc_time 235 #2282c0 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
	)
fi
