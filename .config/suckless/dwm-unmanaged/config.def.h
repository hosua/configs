...
static const char *kittymenu[] = { "/home/hoswoo/Scripts/kittysessions.sh", NULL };
...
static Key keys[] = {
	...
	{ MODKEY, 			            XK_backslash, spawn,       CMD("st") },
